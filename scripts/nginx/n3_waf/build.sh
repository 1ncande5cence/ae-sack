...
cp $VSACK/scripts/nginx/n3_waf/vsack.conf ./log/
cp $VSACK/scripts/nginx/n3_waf/ban_line.list ./log/

#$VSACK/viper/BranchForcer/afl-clang-fast-flip nginx.bc -o nginx.fuzz -Wl,--export-dynamic -Wl,-rpath=/usr/local/modsecurity/lib/ $EXTRA_LDFLAGS >compile.log 2>&1
