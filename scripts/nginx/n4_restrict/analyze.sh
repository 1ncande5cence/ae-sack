...
echo "What mode is this? [1] branchonly [2] mem-modification [3] original viper"
read -r mode_choice
...
grep -a 'HTTP/1.1" 200' ./log/host.access.log | grep -v 'HTTP/1.1" 200 0' | awk '{print $1}' | sort -u > success.log
