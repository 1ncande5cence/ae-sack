            ...
            for line in f:
                ...
                if line:
                    ...
                    if len(parts) == 4:
                        flip_entry = {
                            'id': int(parts[0]),
                            'enter_count': int(parts[1]),
                            'from_value': int(parts[2]),
                            'to_value': int(parts[3])
                        }
...
def main():
    ...
    for i, flip in enumerate(flips, 1):
        ...
        print(f"Flip: {flip['from_value']} -> {flip['to_value']}")
...
# python3 flip_code_extractor.py flip.success.log branch_line_log /path/to/nginx/source

#python3 flip_code_extractor.py flip.success.log  branch_line_log /methodology_viper/nginx-collection/nginx-basic-auth-new/nginx-basic-auth