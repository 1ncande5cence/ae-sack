...
2. Run the crawler:
   ...
   ```bash
   python3 general_crawler.py --base-url http://www.proftpd.org/docs/contrib/
   ```
      ```bash
   python3 general_crawler.py --base-url http://www.proftpd.org/docs/howto/index.html
...
2. Generate the oracle using the selected feature, run:
   ...
   ```bash
   python3 oracle_generation_with_provided_feature.py --feature-json feature_output/proftpd_features.json
   ```
