...
2. Generate the oracle using the selected feature, run:
   ...
   ```bash
   python3 oracle_generation_with_provided_feature.py --feature-json feature_output/apache_features.json
   ```
...
C1 comes from `2_Authentication_Modules_20250718_165308.md`  
C2 comes from `5_Request_Filtering_(mod_security)_20250718_165436.md`  
C3 comes from `18_Request_Method_Restrictions_20250718_165844.md`  
C4 comes from `7_Logging_and_Auditing_(mod_log_config,_mod_log_forensic)_20250718_165502.md`  
C5 comes from `6_Input_Validation_(mod_security,_mod_rewrite)_20250718_165443.md`  
