...
2. Generate the oracle using the selected feature, run:
   ...
   ```bash
   python3 oracle_generation_with_provided_feature.py --feature-json feature_output/wireshark_features.json
   ```
...
W1 comes from `2_Input_Validation_and_Dissector_Hardening_20250802_152904.md`  
